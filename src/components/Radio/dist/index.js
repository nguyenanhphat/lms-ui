...
exports.Radio = react_1.forwardRef(function (props, ref) {
    ...
    return (react_1["default"].createElement(Component, __assign({}, rest, { ref: ref, className: classOfRoot, role: "radio" }),
        react_1["default"].createElement(Icon_1["default"], __assign({}, iconProps, { ref: iconRef, className: styles_module_scss_1["default"].icon, component: iconOfRadio })),
        _children,
        react_1["default"].createElement(Input_1["default"], { readOnly: true, type: "radio", ref: refOfInput, name: checkboxName, value: value, className: styles_module_scss_1["default"].input, checked: isChecked, onChange: onChangeComposed })));
});
