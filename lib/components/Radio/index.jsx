...
var compose_1 = __importDefault(require("../../utils/compose"));
...
exports.Radio = react_1.forwardRef(function (props, ref) {
    ...
    return (<Component {...rest} ref={ref} className={classOfRoot} role="radio">
      <Icon_1.default {...iconProps} ref={iconRef} className={styles_module_scss_1.default.icon} component={iconOfRadio}/>
      {_children}
